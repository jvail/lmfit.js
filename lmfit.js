...
var Module = typeof lmfit !== "undefined" ? lmfit : {};
...
var lmfit = function() {
 var Module = {
  "print": function(text) {
   if (typeof importScripts === "function") postMessage(text); else console.log(text);
  },
 ...
 var DYNAMIC_BASE = 5248800, DYNAMICTOP_PTR = 5744;
 ...
 var asm = createWasm();
 var ___wasm_call_ctors = Module["___wasm_call_ctors"] = asm["g"];
 var _do_fit = Module["_do_fit"] = asm["h"];
 var _malloc = Module["_malloc"] = asm["i"];
 var _free = Module["_free"] = asm["j"];
 var stackSave = Module["stackSave"] = asm["k"];
 var stackRestore = Module["stackRestore"] = asm["l"];
 var stackAlloc = Module["stackAlloc"] = asm["m"];
 var calledRun;
