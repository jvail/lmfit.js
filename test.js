...
(function () {
  ...
  fs.writeFileSync('logistic.csv', 't;data;fit\n');
  var csv = '';
  for (var t = 0; t < data.m; t++)
    csv += data.t[t] + ';' + vals[t] + ';' + data.f(data.t[t], ret.params) + '\n';
  fs.appendFileSync('logistic.csv', csv);
...
(function () {
  ...
  var data = {    
    ...
    , par: new Float64Array(3)
    , m: 0
    , t: new Float64Array([ 2.0, 3.0, 4.0, 5.0, 20.0, 37.0, 38.0, 39.0, 40.0 ])
    , y: new Float64Array([ 32.9, 37.0, 39.4, 38.7, 30.0, 15.8, 13.3, 11.2, 8.0 ])
  }
